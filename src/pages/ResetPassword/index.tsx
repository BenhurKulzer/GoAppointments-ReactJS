...
const ResetPassword: React.FC = () => {
  ...
  return (
    <Container>
      <Content>
        <AnimationContainer>
          <img src={logoImg} alt="RocksBarber" />

          <Form ref={formRef} onSubmit={handleSubmit}>
            <h1>Resetar senha</h1>

            <Input name="password" icon={FiLock} type="password" placeholder="Informe sua nova Senha" />

            <Input name="password_confirmation" icon={FiLock} type="password" placeholder="Confirmação sua Senha" />
